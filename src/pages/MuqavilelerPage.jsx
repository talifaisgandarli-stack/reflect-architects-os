            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-[#e8e8e4]">
                  ...
                  <th className="text-left px-4 py-3 font-medium text-[#888]">Nömrə</th>
                  ...
                  <th className="text-left px-4 py-3 font-medium text-[#888]">İmzalandı</th>
                ...
                {filtered.map(c => {
                  ...
                  return (
                    <tr key={c.id} className="border-b border-[#f5f5f0] hover:bg-[#fafaf8]">
                      ...
                      <td className="px-4 py-3 text-[#555]">{c.contract_number || '—'}</td>
                      ...
                      <td className="px-4 py-3 text-[#555]">{c.sign_date ? new Date(c.sign_date).toLocaleDateString('az-AZ') : '—'}</td>
                      <td className="px-4 py-3 text-[#555]">{c.end_date ? new Date(c.end_date).toLocaleDateString('az-AZ') : '—'}</td>
                      <td className="px-4 py-3 text-right font-bold text-[#0f172a]">{c.amount > 0 ? fmt(c.amount) : '—'}</td>
